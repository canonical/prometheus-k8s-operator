...
class MetricsEndpointAggregator(Object):
    ...
    def set_alert_rule_data(
        self, app_name: str, unit_rules: dict, label_rules: bool = True
    ) -> None:
        ...
        """
        if label_rules:
            rules = self._label_alert_rules(unit_rules, app_name)
        updated_group = {"name": self.group_name(app_name), "rules": rules}
    ...
    def group_name(self, app_name: str) -> str:
        ...
        Args:
            app_name: string name of a related application.

        Returns:
            a string Prometheus alert rules group name for the application.
        """
        return "juju_{}_{}_{}_alert_rules".format(self.model.name, self.model.uuid[:7], app_name)
