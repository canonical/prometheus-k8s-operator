...
class PrometheusCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        self.framework.observe(self.on.prometheus_remote_write_relation_created, self._configure)
        self.framework.observe(self.on.prometheus_remote_write_relation_broken, self._configure)
